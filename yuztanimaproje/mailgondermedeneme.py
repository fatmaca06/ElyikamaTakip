...
try: #işlemi kontrol amaçlı bu blok içerisinde yazdım
    ...
    mail.login("fatmacaaa06@gmail.com", "181388fA.") #gmail servera giriş yapmak gerekiyor

    mesaj = MIMEMultipart()
    mesaj["From"] = "fatmacaaa06@gmail.com"           # Gönderen hesabın gmail olması gerekli
    mesaj["To"] = " fatmaca06@icloud.com"            # Alıcı
